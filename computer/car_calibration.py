...
class CollectTrainingData(threading.Thread):
    ...
    def run(self):
        ...
        self.sctSteer.cmd_q.put(ClientCommand(ClientCommand.SEND, ('SPEED',INITIAL_CAR_SPEED_COMMAND)))
        ...
        flipped_image_array = np.zeros((1, 38400), dtype=np.uint8)
        flipped_label_array = np.zeros(1, dtype=np.uint8)
            ...
            while True:
                try:
                    ...
                    if reply.type == ClientReply.SUCCESS:
                        ...
                        #  middle line
                        cv2.line(i,(0,240/2),(320,240/2),(255,255,255),1)
                        cv2.line(i,(320/2,0),(320/2,240),(255,255,255),1)
                        X1 = int(totalAngle*1.5)+320/4
                        X1=320/4
                        cv2.rectangle(i,(0,240/4),(320,240*3/4),(0,0,255),1)
                        #cv2.line(i,(0,0),(320,240),(255,255,255),1)
